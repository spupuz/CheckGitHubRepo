...
return { $, sleep, debounce, esc, safeUrl, cssVar, daysBetween, timeAgo, dayKey, toRGBA, updateRate, rateLimitMsg, headers, affiliations, getUsernames, signature, multiOwner, syncHash, applyHash, tokenStorage, downloadBlob };
})();
